...
flowchart TD
    subgraph Tier1["🏢 Tier 1: Company & Team Governance (docs/01_company_and_team/)"]
        ...
        T1_9["09. Collaborative Review Culture"]
        T1_10["10. AI Agent Skills Framework"]
        T1_11["12. Code Commenting Standards"]
    end
...
- **Executive Presentation Deck (EM Walkthrough):** See: **[presentation/README.md](./presentation/README.md)** 📊
