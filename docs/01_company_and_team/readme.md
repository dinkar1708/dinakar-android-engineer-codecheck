...
| **9. Engineering Culture** | [`09_collaborative_review_culture.md`](./09_collaborative_review_culture.md) | Psychological safety, blameless retrospectives & collaborative code review ethics | `CULTURE` |
...
| **11. AI Tooling Adoption** | [`11_ai_tools_adoption_proposal.md`](./11_ai_tools_adoption_proposal.md) | Business justification, ROI, and security guardrails for AI coding assistants | `AI-STRATEGY` |
| **12. Code Commenting Standards** | [`12_code_commenting_and_documentation_standards.md`](./12_code_commenting_and_documentation_standards.md) | KDoc requirements, "Why, Not What" philosophy, inline comment taxonomy & Compose previews | `CODE-QUALITY` |
